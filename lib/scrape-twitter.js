...
async function initBrowser() {
  ...
  try {
    ...
    // NOTE: masking the automation fingerprint (AutomationControlled flag, real
    // Chrome UA, navigator.webdriver override) was tried on 2026-09-08 and did
    // NOT clear the Cloudflare challenge — 5/5 handles stayed blocked. The block
    // is runner-IP reputation, not browser fingerprint. Don't re-try that lever.
